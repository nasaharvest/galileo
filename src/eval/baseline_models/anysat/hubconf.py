...
from .models.networks.encoder.Any_multi import AnyModule  # Import your actual model class
from .models.networks.encoder.Transformer import TransformerMulti
from .models.networks.encoder.utils.ltae import PatchLTAEMulti
from .models.networks.encoder.utils.patch_embeddings import PatchMLPMulti
    ...
    def __init__(self, model_size="base", flash_attn=True, **kwargs):
        ...
        with warnings.catch_warnings():
            ...
            self.model = AnyModule(
                projectors=projectors, spatial_encoder=self.spatial_encoder, **self.config
            )
