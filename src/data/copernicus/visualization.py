"""Visualization utilities for Copernicus satellite data.

This module provides high-level plotting functions for displaying
satellite imagery, coverage maps, and analysis results for both:
- Sentinel-2 optical imagery (RGB, false color)
